...
POKEMONTOCREST = {
  ...
  #MODDED - CRESTS AND AEVIAN FORMS MOD - START (Recognizing Crests as Crests)
  :FURRET => :FURRCREST,              :NINETALES => :NINECREST,
  :ARCANINE => :ARCACREST,            :SNORLAX => :SNORCREST,
  :BIBAREL => :BIBACREST,             :CHESNAUGHT => :CHESCREST,
  :AVALUGG => :AVALCREST,             :PRIMARINA => :PRIMACREST,
  :TOGEKISS => :TOGECREST,            :SWAMPERT => :SWAMPCREST,
  :VENUSAUR => :VENUCREST,            :BLASTOISE => :BLASCREST,
  :CHARIZARD => :CHARCREST,           :BUTTERFREE => :BUTTERCREST,
  :GREEDENT => :GREEDCREST,           :WEEZING => :WEEZCREST,
  :BANETTE => :BANECREST,
