...
:NINECREST => {
	...
	:desc => "When Kantoan Ninetales uses Safeguard, it will also apply Aurora Veil. Aurora Veil is automatically applied while Alolan Ninetales is on the Field during Hail/Snow.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:GREEDCREST => {
	:ID => 1119,
	:name => "Greedent Crest",
	:desc => "Forages for a berry when below half HP, or at full with Gluttony. Has 20% increased Sp. Defense and Defense.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
